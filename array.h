...
#define ARRAY(name, type, init_max) struct array_s name = { init_max, 0, sizeof(type), NULL }

#define array_out(pos, a) ((char *)pos >= (char *)(a)->data + ((a)->item_size * (a)->item_num))

#define array_for_each(pos, a) for(pos = (a)->data; !array_out(pos, a); pos++)
