 ...
 */
static __inline__ void __list_add(struct list_head *nnew, struct list_head *prev, struct list_head *next)
{
	next->prev = nnew;
	nnew->next = next;
	nnew->prev = prev;
 ...
 */
static inline void hlist_move_list(struct hlist_head *old, struct hlist_head *nnew)
{
